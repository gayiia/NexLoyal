                    ...
                    <div class="flex min-h-screen">
                        ...
                        <main class="flex-1 px-10 py-8">
                            <header class="flex flex-wrap items-center justify-between gap-4">
                                <div>
                                    <p class="text-xs uppercase tracking-[0.3em] text-slate-400 nl-text-muted">Dashboard</p>
                                    <h1 class="text-3xl font-semibold text-slate-50">Loyalty performance overview</h1>
                                    <p class="mt-2 text-sm text-slate-300 nl-text-muted">Charts pull from Shopify webhooks once connected.</p>
                                </div>
                                <div class="flex items-center gap-3">
                            ...
                            <section class="mt-6 rounded-2xl border border-slate-800 bg-slate-900/70 nl-panel p-5 nl-panel">
                                <div class="flex flex-wrap items-center gap-4">
                                    <div class="flex flex-col gap-2">
                                        <label class="text-xs uppercase tracking-[0.2em] text-slate-400 nl-text-muted">Date range</label>
                                        <select class="rounded-lg border border-slate-700 bg-slate-950/60 px-3 py-2 text-sm text-slate-200 nl-chip">
                                    ...
                                    <div class="flex flex-col gap-2">
                                        <label class="text-xs uppercase tracking-[0.2em] text-slate-400 nl-text-muted">Tier</label>
                                        <select class="rounded-lg border border-slate-700 bg-slate-950/60 px-3 py-2 text-sm text-slate-200 nl-chip">
                                    ...
                                    <div class="flex flex-col gap-2">
                                        <label class="text-xs uppercase tracking-[0.2em] text-slate-400 nl-text-muted">Segment</label>
                                        <select class="rounded-lg border border-slate-700 bg-slate-950/60 px-3 py-2 text-sm text-slate-200 nl-chip">
                                    ...
                                    <div class="flex flex-col gap-2">
                                        <label class="text-xs uppercase tracking-[0.2em] text-slate-400 nl-text-muted">Reward type</label>
                                        <select class="rounded-lg border border-slate-700 bg-slate-950/60 px-3 py-2 text-sm text-slate-200 nl-chip">
                                    ...
                                    <button class="ml-auto rounded-xl bg-sky-400 px-4 py-2 text-sm font-semibold text-slate-950 shadow-lg shadow-sky-500/30">Apply filters</button>
                                </div>
                            </section>
